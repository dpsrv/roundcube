...
docker exec -it mysql mysql -h $ROUNDCUBEMAIL_DB_HOST -P $ROUNDCUBEMAIL_DB_PORT -u root -p$MYSQL_ROOT_PASSWORD mysql -e "GRANT ALL PRIVILEGES ON $ROUNDCUBEMAIL_DB_NAME.* TO '$ROUNDCUBEMAIL_DB_USER'@'%';"
