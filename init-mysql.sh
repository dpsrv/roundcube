...
docker exec -it mysql mysql -h $ROUNDCUBEMAIL_DB_HOST -P $ROUNDCUBEMAIL_DB_PORT -u root -p$MYSQL_ROOT_PASSWORD mysql -e "GRANT SELECT, INSERT, UPDATE, DELETE, CREATE, INDEX, DROP, ALTER, CREATE TEMPORARY TABLES, LOCK TABLES ON $ROUNDCUBEMAIL_DB_NAME.* TO '$ROUNDCUBEMAIL_DB_USER'@'%';"
